...
export default function AnalyticsPage() {
  ...
  return (
    <>
      ...
      <div className="mb-5 inline-flex items-center gap-1 rounded-xl border border-white/[0.06] bg-white/[0.02] p-1 text-[12px]">
        {ranges.map((r) => (
          <button
            key={r}
            onClick={() => setRange(r)}
            className={cn(
              ...
              range === r ? "text-white" : "text-ink-300 hover:text-white"
            )}
          >
            {range === r && (
              <motion.span
