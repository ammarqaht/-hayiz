  ...
  return (
    <>
      ...
      <div className="overflow-hidden rounded-2xl border border-ink-100/[0.06] bg-ink-900/40">
        <div className="grid grid-cols-[1.4fr_1fr_1fr_0.8fr_0.8fr_0.8fr] border-b border-ink-100/[0.06] px-6 py-3 text-[10px] font-mono uppercase tracking-wider text-ink-400">
          <div>Customer</div>
          <div>Seat</div>
          <div>Time</div>
          <div>Duration</div>
        ...
        <Stagger className="divide-y divide-ink-100/[0.04]" staggerChildren={0.04}>
          {list.map((r) => (
            <motion.div
              key={r.id}
